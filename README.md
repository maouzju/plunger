...
下载发布包并解压后，双击 `Plunger.exe` 即可运行，无需安装 Python：

👉 [**下载 Windows 发布包**](https://github.com/maouzju/plunger/releases/latest)

如果首次启动时被 Windows SmartScreen 拦住，这通常是“来自互联网的未签名程序”的信任提示。你可以点击“更多信息” -> “仍要运行”，或者在 PowerShell 里移除下载标记：
